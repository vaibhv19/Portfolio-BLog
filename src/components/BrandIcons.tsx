...
export function LeetCodeIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      <path d="M13.483 0a1.374 1.374 0 0 0-.961.438L7.116 6.226a1.374 1.374 0 0 0-.416.947c0 .367.14.718.416.974l4.088 4.088a1.375 1.375 0 0 0 1.944 0 1.375 1.375 0 0 0 0-1.944L9.82 7.173l3.663-3.663a1.375 1.375 0 0 0 0-1.944A1.374 1.374 0 0 0 13.483 0zm-6.17 7.042a1.374 1.374 0 0 0-1.077.518L.484 14.195a1.375 1.375 0 0 0 0 1.944l5.752 6.635a1.375 1.375 0 0 0 2.05-.106 1.375 1.375 0 0 0-.106-2.05L2.928 15.167l5.244-6.046a1.375 1.375 0 0 0-.859-2.079zM16.4 12.062a1.375 1.375 0 0 0-.972.403 1.375 1.375 0 0 0 0 1.944l3.663 3.663-3.663 3.663a1.375 1.375 0 0 0 0 1.944 1.375 1.375 0 0 0 1.944 0l4.526-4.526a1.375 1.375 0 0 0 0-1.944l-4.526-4.526a1.374 1.374 0 0 0-.972-.403z" />
    </svg>
  );
}
