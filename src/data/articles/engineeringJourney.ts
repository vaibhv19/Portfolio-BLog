...
export const articleEngineeringJourney: WritingArticle = {
  ...
  content: [
    ...
    "## 1 / Client-Side Mechanics & Browser Compute",
    ...
    "## 2 / Backend Foundations & Object-Oriented Rigor",
    ...
    "## 3 / Production Reality & Operational Infrastructure",
    ...
    "## 4 / Multi-Agent Systems & Context Orchestration",
    ...
    "## 5 / AI Observability & Hybrid Retrieval Systems",
    ...
    "## 6 / Safe Runtime Isolation & Agent Evaluation",
